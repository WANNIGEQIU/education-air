...
import com.air.server.course.mapper.EduChapterMapper;
...
public class EduChapterServiceImpl  implements EduChapterService {
    ...
    public Map<String, List<ChapterDto>> queryChapter(String courseId) {
        ...
        // 查小节
         chapters.forEach(chapter -> {
             ...
             List<EduVideo> eduVideos = videoMapper.queryList(chapterDto.getId());
    ...
    public Boolean deleteChapter(String chapterId) {
        ...
        if (count > 0) {
            throw new CourseException(ResultEnum.ERROR_CHAPTER_DELETE);
        }
        // 删除章节
